...
export default function Model(props) {
  const group = useRef();
  const { nodes } = useGLTF("/robotBlue.gltf");
            ...
            <group name="Object_2">
              <group name="RootNode">
                <group name="bot_geo">
                  ...
                  <group name="earTube" />
                  <group name="face">
                    <group name="close" position={[-13.39, -0.04, -1.52]} />
                    <group
                      name="eye"
                      position={[0.41, -4.26, -1.92]}
                      scale={1.16}
                    />
                    <group name="eyeClose" position={[-16, 1.37, -1.5]} />
                    <group
                      name="eyeCloseKawaii"
                    ...
                    >
                      ...
                      />
                      <group name="eyeClose1" position={[-16, 1.37, -1.5]} />
                      <group
                    ...
                    <group name="happy" position={[-13.39, -0.05, -1.52]} />
                    <group name="o" position={[-13.39, 1.37, -1.25]} />
                    ...
                    <group name="DeformationSystem">
                      <group name="Object_159">
                        ...
                        <group
                          ...
                          scale={1.15}
                        />
                        <group name="Object_209" position={[-16, 1.37, -1.5]} />
                        <group
                          name="Object_211"
                ...
                <group name="holo" scale={1.88}>
                  <group
                    ...
                    scale={0.99}
                  >
                    <group name="group39" rotation={[Math.PI, -1.09, Math.PI]}>
                      <group
                        name="group37"
                        position={[-1.78, 3.61, 1.3]}
                        rotation={[-1.01, 0.97, -2.23]}
                      >
                        <group
                          name="group31"
                          position={[0, -0.74, 0]}
                                ...
                                >
                                    ...
                                    >
                                      <group name="pSuperShape2" scale={2.08}>
                                        <mesh
                                          ...
                                          material={
                                            nodes.pSuperShape2_holo1_0.material
                                          }
                                        />
                                      </group>
                                      <group name="pSuperShape3" scale={2.08}>
                                        <mesh
                                          ...
                                          material={
                                            nodes.pSuperShape3_holo1_0.material
                                          }
                                        />
                                      </group>
                                    </group>
                                  ...
                                  >
                                    <mesh
                                      ...
                                      material={
                                        nodes.MASH1_ReproMesh12_holo1_0.material
                                      }
                                    />
                                  </group>
                                </group>
                                ...
                                >
                                  <group name="MASH1_ReproMesh15">
                                    <mesh
                                      ...
                                      material={
                                        nodes.MASH1_ReproMesh15_holo1_0.material
                                      }
                                    />
                                  </group>
                                </group>
                  ...
                  <group name="ground" position={[0, 0.39, 0]}>
                    ...
                    <group name="pPipe2" position={[0, -0.58, 0]}>
                      <group
                    ...
                    <group name="pPipe4" position={[0, -0.43, 0]}>
